...
var hitgameserice = function(){
    var dealercard_player = async function(data){
        ...
        try{
                ...
                var dealer_move = dbuserobject.moves.dealer;
                dealer_move.push(data_card_generator.select_card);
    ...
    return {
        dealercard_player:function(data){
            return dealercard_player(data);
        },
