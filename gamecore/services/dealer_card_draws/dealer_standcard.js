...
var standgameserice = function(){
    var standcard_dealer = async function(data){
        ...
        try{
               ...
               // const deck_card = dbuserobject.current_deck;
                ...
                user_model.create_edit_object({
                    ...
                    username:dbuserobject.username,
                    iscomplete:dbuserobject.iscomplete,
                    shuffled_deck:dbuserobject.shuffled_deck,
                    move_dealer:dbuserobject.moves.dealer,
                    move_player:dbuserobject.moves.player,
                    current_deck:dbuserobject.current_deck,
    ...
    var check_validation =async function(data){
        ...
        try{
            ...
            return {
                ...
                usercheckisinstand:{status:usercheckisinstand,message:usercheckisinstand==false?'dealer cannot take a hit as player doesnt chose to stand ':'pass'}
            }
        }
        catch(err){
            throw err;
    ...
    return {
        standcard_dealer:function(data){
            return standcard_dealer(data);
        },
...
module.exports = standgameserice;