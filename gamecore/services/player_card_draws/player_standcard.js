...
var standgameserice = function(){
    var standcard_player = async function(data){
    ...
    var check_validation =async function(data){
        ...
        try{
            ...
            return {
               ...
               // usercheckisinstand:{status:usercheckisinstand,message:usercheckisinstand==false?'user cannot take a hit as it chose to stand ':'pass'}
            }
        }
        catch(err){
            throw err;
    ...
    return {
        standcard_player:function(data){
            return standcard_player(data);
        },
